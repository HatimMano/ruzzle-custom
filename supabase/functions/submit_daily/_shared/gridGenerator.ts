...
export function findAllWords(
  ...
  function dfs(row: number, col: number, path: string, visited: boolean[][], node: Trie) {
...
// Cherche un chemin valide pour un mot donné (adjacence + pas de répétition de cellule)
